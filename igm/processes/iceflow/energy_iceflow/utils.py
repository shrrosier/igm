...
def gauss_points_and_weigths(cfg,ord_gauss):

    if ord_gauss == 3:
        n = np.array([0.11270, 0.5,     0.88730], dtype=cfg.processes.iceflow.emulator.precision)
        w = np.array([0.27778, 0.44444, 0.27778], dtype=cfg.processes.iceflow.emulator.precision)
    elif ord_gauss == 5:
        n = np.array([0.04691, 0.23077, 0.5,     0.76923, 0.95309], dtype=cfg.processes.iceflow.emulator.precision)
        w = np.array([0.11847, 0.23932, 0.28444, 0.23932, 0.11847], dtype=cfg.processes.iceflow.emulator.precision)
    elif ord_gauss == 7:
